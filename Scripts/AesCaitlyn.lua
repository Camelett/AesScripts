...
function reversedE()
  if config.defensiveSubMenu.reversedE and config.defensiveSubMenu.enableE and myHero:CanUseSpell(_E) == READY then
...
function menu()
  ...
  config.defensiveSubMenu:addParam("enableE", "Enable reversed "..skills.skillE.name, SCRIPT_PARAM_ONOFF, false)
